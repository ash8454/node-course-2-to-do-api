...
describe('DELETE /todos/:id', () => {
  it('should remove a todo', (done) => {
    ...
    it('should return 404 when removing a todo as second user', (done) => {
...
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    ...
    //200
    //text is changed, completed is true. completeadA tis a number
  });

  it('should return 404 user for updating the todo as second user', (done) => {
    //grab id of first item
    var hexId = todos[0]._id.toHexString();
    var text = 'This should be new text';
    //auth as first user
